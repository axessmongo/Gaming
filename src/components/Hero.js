...
const Hero = () => {
  return (
    <div className="flex flex-col xl:flex-row xl:h-screen items-center pt-[5rem] w-full overflow-hidden" >
        ...
        <Fade bottom >
            <div className="flex flex-col flex-1 h-full items-center xl:items-start justify-center text-white text-center xl:text-start space-y-8 mb-[4rem] " >
                ...
                Welcome to Dream Game Builders, where imagination meets innovation in every pixel and storyline.                </p>
